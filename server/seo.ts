...
export function generateRobotsTxt(baseUrl: string): string {
  ...
  return [
    ...
    "Allow: /trending",
    "",
    "# Public APIs required by crawlers & browsers to render dynamic page content",
    "Allow: /api/articles",
    "Allow: /api/articles/",
    "Allow: /api/contributors",
    "Allow: /api/contributors/",
    "Allow: /api/spotlight",
    "Allow: /api/spotlight/",
    "Allow: /api/events",
    ...
    "",
    "# Disallow private administration, authentication, and sensitive management APIs",
    "Disallow: /admin",
    "Disallow: /admin/",
    "Disallow: /auth/",
